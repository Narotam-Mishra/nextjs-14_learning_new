...
# However, for development mode builds, a page will be pre-rendered for every request.
...
3). Static Rendering is great for performance and use cases include blogs, documentation, marketing pages etc.
